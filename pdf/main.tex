...
We also show that memory reuse for signals is generally limited, since recursive signals combinators depend on their input signals to compute future values.
