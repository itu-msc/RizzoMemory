...
Functional reactive programming (FRP) is a programming paradigm for building \textit{reactive} programs in a declarative and functional style. FRP languages model time-varying values as first class values. % more on why programming languages needs to have a way to model these first class time-varying values. 
