...
A downside of this approach would be the increased program size caused by the duplication of inserting the advance semantics in the tail of every signal. This increase in size would cause longer compile times and potentially worsen runtime performance.
