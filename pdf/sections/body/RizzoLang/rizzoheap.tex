...
\begin{enumerate}
    ...
    \item \textbf{Efficient insertion}: New signals created during an update must be inserted at the end of the now heap, which is at the current position in the iteration. With a linked list, this is O(1).
