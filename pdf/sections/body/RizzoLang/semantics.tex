...
\todo{conceptual, show heap: location 1, location 2, \dots location N, show their reference count, dummy data, then using colours or arrows show how SOME of these form the signal heap}
