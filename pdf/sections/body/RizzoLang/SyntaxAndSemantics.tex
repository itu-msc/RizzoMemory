...
Based on these requirements, we have chosen to structure our heap as a single linked list. This gives us a simple way to maintain the topological order of signals, as we can ensure that when a new signal is created, it is added after the split between the \texttt{Now} and \texttt{Earlier} heaps. \dots
