...
\citeauthor*{rizzo_modal_2025}~\cite{rizzo_modal_2025} introduces a set of constructors for these modal types. For the \texttt{Later} type the constructors are:
