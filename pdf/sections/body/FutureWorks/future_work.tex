...
While all signal combinators can be implemented in\ \todo{RizzoLang}, some of these may allocate more memory than necessary.
...
An efficient implementation of $mk\_sig$ defined in the runtime would be able to avoid these repeated allocations.

\todo{How much detail do we need to provide?}
