...
let builtins = [
  ...
  mk "mod" ~ownership:(Some [Refcount.Borrowed; Refcount.Borrowed]) (TFun (Cons1(TInt, [TInt]), TInt)) ();
  ...
  mk "abs" ~ownership:(Some [Refcount.Borrowed]) (TFun (Cons1(TInt, []), TInt)) ();
  mk "min" ~ownership:(Some [Refcount.Borrowed; Refcount.Borrowed]) (TFun (Cons1(TInt, [TInt]), TInt)) ();
  mk "max" ~ownership:(Some [Refcount.Borrowed; Refcount.Borrowed]) (TFun (Cons1(TInt, [TInt]), TInt)) ();
  mk "clamp" ~ownership:(Some [Refcount.Borrowed; Refcount.Borrowed; Refcount.Borrowed]) (TFun (Cons1(TInt, [TInt; TInt]), TInt)) ();
  ...
  mk "string_contains" ~ownership:(Some [Refcount.Borrowed; Refcount.Borrowed]) (TFun (Cons1(TString, [TString]), TBool)) ();
  mk "string_starts_with" ~ownership:(Some [Refcount.Borrowed; Refcount.Borrowed]) (TFun (Cons1(TString, [TString]), TBool)) ();
  mk "string_ends_with" ~ownership:(Some [Refcount.Borrowed; Refcount.Borrowed]) (TFun (Cons1(TString, [TString]), TBool)) ();
